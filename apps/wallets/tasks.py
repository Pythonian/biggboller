"""Module for handling email tasks related to wallets."""
...
def send_deposit_email(request, deposit):
    ...
    try:
        ...
        logger.error(f"Error sending deposit email for user {deposit.user}: {e}")
...
def send_withdrawal_email(request, withdrawal):
    ...
    try:
        ...
        logger.error(f"Error sending withdrawal email for user {withdrawal.user}: {e}")
